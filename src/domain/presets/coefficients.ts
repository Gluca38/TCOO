  ...
  compute: {
    onprem: {
      capex: {
        ...
        noteTemplate: 'Ersatzinvestition Virtualisierungshosts.',
      },
    },
    cloud: {
      opex: {
  ...
  storage: {
    onprem: {
      capex: {
        ...
        basis: 'per-tb',
        usefulLifeYears: 5,
        noteTemplate: 'Speichersystem, nutzbare Kapazität.',
      },
    },
    cloud: {
      opex: {
  ...
  facility: {
    onprem: {
      opex: {
        ...
        noteTemplate: 'Flächen- und Energieumlage.',
      },
    },
    /**
  ...
  licenses: {
    ...
    cloud: {
      ...
      opex: {
        ...
        basis: 'per-vm',
        escalation: 0.05,
        noteTemplate: 'Verbleibende Lizenzen; ein Teil ist in den Diensten enthalten.',
      },
    },
  },
  ...
  staff: {
    ...
    cloud: {
      ...
      opex: {
        ...
        basis: 'per-fte',
        escalation: null,
        noteTemplate: 'Plattformsteuerung und Betrieb; Hardwarebetreuung entfällt.',
      },
    },
  },
  ...
  migration: {
    ...
    cloud: {
      ...
      capex: {
        ...
        basis: 'per-vm',
        usefulLifeYears: 3,
        noteTemplate: 'Migrationsleistung, einmalig.',
      },
    },
  },
